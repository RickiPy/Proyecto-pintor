...
/**
 * Componente que muestra un banner superior con información del portafolio
 * Incluye logo, nombre del desarrollador, rol profesional, redes sociales y tecnologías usadas
 * @returns {JSX.Element} Banner del portafolio
 */
const PortfolioBanner = () => {
  return (
    // Contenedor principal con gradiente de fondo
    <div className="bg-gradient-to-r from-secondary-900 to-primary-900 text-white">
      {/* Contenedor con ancho máximo y padding vertical */}
        ...
        <div className="md:hidden">
          <div className="flex flex-col items-center gap-2 text-center">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-bold text-primary-200">Ricki</span>
              <span className="text-primary-300">|</span>
              <span className="text-primary-200">Fullstack Dev</span>
            </div>
        ...
        <div className="hidden md:flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-sm">
              <span className="text-primary-300">|</span>
              <span className="font-medium">Proyecto de Portafolio por</span>
              <span className="font-bold text-primary-200">Ricki</span>
              <span className="text-primary-300">|</span>
              <span className="text-primary-200">Fullstack Developer</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs px-2 py-1 rounded-full bg-primary-900/50 text-primary-300 border border-primary-700/50">
                React
              </span>
              <span className="text-xs px-2 py-1 rounded-full bg-primary-900/50 text-primary-300 border border-primary-700/50">
                Tailwind
